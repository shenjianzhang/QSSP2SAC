...
type :: sachead
    real(kind=4) :: delta, depmin, depmax, scale, odelta
    real(kind=4) :: b, e, o, a, internal1
    real(kind=4) :: t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, f
    real(kind=4) :: resp0, resp1, resp2, resp3, resp4
    real(kind=4) :: resp5, resp6, resp7, resp8, resp9
    real(kind=4) :: stla, stlo, stel, stdp
    real(kind=4) :: evla, evlo, evel, evdp, mag
    real(kind=4) :: user0, user1, user2, user3, user4
    real(kind=4) :: user5, user6, user7, user8, user9
    real(kind=4) :: dist, az, baz, gcarc, internal2, internal3
    real(kind=4) :: depmen, cmpaz, cmpinc
    real(kind=4) :: xminimum, xmaximum, yminimum, ymaximum
    real(kind=4) :: unused1, unused2, unused3, unused4, unused5, unused6, unused7
    integer(kind=4) :: nzyear, nzjday, nzhour, nzmin, nzsec, nzmsec
    integer(kind=4) :: nvhdr, norid, nevid, npts
    integer(kind=4) :: internal4, nwfid, nxsize, nysize, unused8
    integer(kind=4) :: iftype, idep, iztype, unused9, iinst
    integer(kind=4) :: istreg, ievreg, ievtyp, iqual, isynth
    integer(kind=4) :: imagtyp, imagsrc, unused10, unused11, unused12
    integer(kind=4) :: unused13, unused14, unused15, unused16, unused17
    integer(kind=4) :: leven, lpspol, lovrok, lcalda, unused18
...
! constants
real(kind=4), parameter    :: SAC_rnull = -12345.0
integer(kind=4), parameter :: SAC_inull = -12345
integer(kind=4), parameter :: SAC_lnull = -12345
...
implicit none
character(len=80), intent(in) :: filename
real(kind=4), allocatable, dimension(:), intent(inout) :: data
type(sachead), intent(inout) :: head
integer(kind=4), intent(inout) :: flag
...
type(sachead), intent(inout) :: head
real(kind=4), allocatable, dimension(:), intent(inout) :: data
integer(kind=4), intent(in) :: tmark
real(kind=4), intent(in) :: t0, t1
integer(kind=4) :: n0, n1
integer(kind=4), intent(inout) :: flag
real(kind=4) :: tref
